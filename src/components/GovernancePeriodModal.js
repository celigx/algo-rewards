  ...
  return (
    <div className={showModal ? "modal showModal" : "modal"}>
      ...
      <div className="bottom">
        <ChoosePeriod title={"Governance period #5"} selectPeriod={selectPeriod} id={5} governancePeriod={governancePeriod} />
        <ChoosePeriod title={"Governance period #4"} selectPeriod={selectPeriod} id={4} governancePeriod={governancePeriod} />
